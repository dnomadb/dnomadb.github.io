...
map.on('load', () => {
    let customlayer = new mapboxgl.TextureLayer(
        ...
        {
            type: 'raster',
            tiles: ['https://a.tiles.mapbox.com/v4/mapbox.terrain-rgb/{z}/{x}/{y}@2x.png?access_token=pk.eyJ1IjoiZG5vbWFkYiIsImEiOiJjaW16aXFsZzUwNHJmdjdra3h0Nmd2cjY1In0.SqzkaKalXxQaPhQLjodQcQ'],
